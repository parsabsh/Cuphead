...
public class WinGameMenu extends Menu implements Initializable {
    ...
    public Scene getScene() {
        ...
        if (scene == null) {
            try {
                AnchorPane root = FXMLLoader.load(new URL(this.getClass().getResource("/fxml/winGame.fxml").toExternalForm()));
